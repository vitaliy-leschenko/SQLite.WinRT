...
namespace SQLite.WinRT.Linq.Base
{
	...
	public static class TypeHelper
	{
	    ...
	    private readonly static Dictionary<Type, TypeCode> typeMapper = new Dictionary<Type, TypeCode>
	    {
	    ...
	    {
	        return type.GetTypeInfo().DeclaredProperties.FirstOrDefault(t => string.Equals(t.Name, name, StringComparison.OrdinalIgnoreCase));
	    }
	    ...
	    {
	        return type.GetTypeInfo().DeclaredMembers.Where(t => string.Equals(t.Name, name, StringComparison.OrdinalIgnoreCase)).ToArray();
	    }
