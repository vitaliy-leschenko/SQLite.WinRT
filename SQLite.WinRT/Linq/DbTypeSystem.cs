...
namespace SQLite.WinRT.Linq
{
    public static class DbTypeSystem
    {
        ...
        {
            if (string.Compare(typeName, "TEXT", StringComparison.CurrentCultureIgnoreCase) == 0 ||
                string.Compare(typeName, "CHAR", StringComparison.CurrentCultureIgnoreCase) == 0
                || string.Compare(typeName, "CLOB", StringComparison.CurrentCultureIgnoreCase) == 0 ||
                string.Compare(typeName, "VARYINGCHARACTER", StringComparison.CurrentCultureIgnoreCase) == 0
                || string.Compare(typeName, "NATIONALVARYINGCHARACTER", StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                return SqlDbType.VarChar;
            }
            if (string.Compare(typeName, "INT", StringComparison.CurrentCultureIgnoreCase) == 0 ||
                string.Compare(typeName, "INTEGER", StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                return SqlDbType.BigInt;
            }
            if (string.Compare(typeName, "BLOB", StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                return SqlDbType.Binary;
            }
            if (string.Compare(typeName, "BOOLEAN", StringComparison.CurrentCultureIgnoreCase) == 0)
            {
    ...
    public class DbQueryType
    {
        ...
        {
            get { return DbTypeSystem.GetDbType(sqlDbType); }
        }
